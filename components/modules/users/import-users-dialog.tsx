        ...
        {state === 'idle' && (
          <div className="flex flex-col gap-5 py-2 min-h-0">
            ...
            <p className="text-sm text-slate-600">
              Descargue la plantilla, complete los datos y suba el archivo para registrar usuarios en lote.
            </p>
            ...
            >
              ...
              <span className="flex-1">
                ...
                <span className="block text-xs text-slate-400">plantilla-usuarios.xlsx</span>
              </span>
              ...
              <table className="w-full text-xs">
                <thead className="sticky top-0 bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="text-left px-3 py-2 text-slate-500 font-semibold">Nombre</th>
